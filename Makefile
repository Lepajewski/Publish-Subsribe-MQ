...
build-broker:
	mkdir -p bin
	cd src/broker && g++ -std=c++17 ../utils/config_parser.cpp ../utils/signal_code.cpp ../utils/socket_io.cpp broker.cpp topic.cpp client.cpp client_thread.cpp signal_handler.cpp message.cpp main.cpp -pthread -o ../../bin/broker -Wall -Wextra
